...
/// </summary>
public abstract class AudioNode: IOutputMixer
{
    ...
    public void MixOutput(Span<float> output)
    {
        // Resize audio buffer
        if (_samples.Length < output.Length)
        {
            Array.Resize(ref _samples, output.Length);
        }
